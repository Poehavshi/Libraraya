...
from app.forms import LoginForm, RegistrationForm, EditProfileForm, PostForm, \
    ResetPasswordRequestForm, ResetPasswordForm, EmptyForm
...
def login():
    """
    Login view with form to log in by username and password
    redirecting to index page, if user is already authenticated
    else check password of user by getting it from db by username
